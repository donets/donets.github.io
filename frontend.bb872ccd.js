...
function Form(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("form", {
    ...
    id: "fieldset"
  }, /*#__PURE__*/_react.default.createElement("p", null, "Please insert your name!"), /*#__PURE__*/_react.default.createElement("p", {
    className: "highlight"
...
},{"react":"n8MK","prop-types":"D9Od"}],"tMm1":[function(require,module,exports) {
"use strict";
...
function HelloList(props) {
  var users = props.usernames;
  var listItems = users.map(function (user) {
    return /*#__PURE__*/_react.default.createElement("li", {
      key: user
    }, "Hello ", user, "!");
  });
  return /*#__PURE__*/_react.default.createElement("ul", null, listItems);
}
...
var _HelloList = _interopRequireDefault(require("./components/HelloList"));
...
var App = function App(_ref) {
  ...
  var _useState = (0, _react.useState)(null),
      ...
      name = _useState2[0],
      setHello = _useState2[1];

  var _useState3 = (0, _react.useState)(false),
      _useState4 = _slicedToArray(_useState3, 2),
      loading = _useState4[0],
      stateLoading = _useState4[1];

  var _useState5 = (0, _react.useState)([]),
      _useState6 = _slicedToArray(_useState5, 2),
      usernameList = _useState6[0],
      setHelloList = _useState6[1];

  var addHello = (0, _react.useCallback)(function (name) {
    setHelloList([].concat(_toConsumableArray(usernameList), [name]));
  });
  var setLoading = (0, _react.useCallback)(function (state) {
    stateLoading(state);
  });
  ...
  var onSubmit = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
      var _event$target$element, fieldset, username, name;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _event$target$element = event.target.elements, fieldset = _event$target$element.fieldset, username = _event$target$element.username;
              fieldset.disabled = true;
              setLoading(true);
              _context2.next = 6;
              return contract.set_hello({
                name: username.value,
                account_id: currentUser.accountId
              }, BOATLOAD_OF_GAS);
  ...
  var signIn = function signIn() {
    wallet.requestSignIn(nearConfig.contractName, "NEAR Hello world");
  };
  ...
  return /*#__PURE__*/_react.default.createElement("main", null, /*#__PURE__*/_react.default.createElement("header", null, /*#__PURE__*/_react.default.createElement("h1", null, "Nearvember hello world"), currentUser ? /*#__PURE__*/_react.default.createElement("p", null, "Currently signed in as: ", /*#__PURE__*/_react.default.createElement("code", null, currentUser.accountId)) : /*#__PURE__*/_react.default.createElement("p", null, "Please login to continue."), currentUser ? /*#__PURE__*/_react.default.createElement("button", {
    onClick: signOut
  }, "Log out") : /*#__PURE__*/_react.default.createElement("button", {
    onClick: signIn
  }, "Log in")), currentUser && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Form.default, {
    onSubmit: onSubmit,
    currentUser: currentUser,
    loading: loading
  }), /*#__PURE__*/_react.default.createElement("h3", null, "Hello list"), usernameList.length ? /*#__PURE__*/_react.default.createElement(_HelloList.default, {
    usernames: usernameList,
    loading: loading
  }) : name && /*#__PURE__*/_react.default.createElement("p", null, "Hello ", name, "!")));
};

App.propTypes = {
  contract: _propTypes.default.shape({
    set_hello: _propTypes.default.func.isRequired,
    get_hello: _propTypes.default.func.isRequired
  }).isRequired,
  currentUser: _propTypes.default.shape({
    accountId: _propTypes.default.string.isRequired,
...
},{"regenerator-runtime/runtime":"QVnC","react":"n8MK","prop-types":"D9Od","big.js":"NYl1","./components/Form":"Y0R1","./components/HelloList":"tMm1"}],"itQ5":[function(require,module,exports) {
var CONTRACT_NAME = undefined || "vinch.testnet";
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/Users/vlad", "/.near/validator_key.json"),
...
//# sourceMappingURL=frontend.bb872ccd.js.map